/*
 ...
 MIT Licence
*/
$.fn.jinplace.editors["extra:checkbox"]={blurAction:"ignore",makeField:function(c,d){var a;"["==d.charAt(0)&&(a=$.parseJSON(d));if(!a||2>a.length)a=["No","Yes"];this.choices=a;var b=$("<input type=checkbox>");b.on("click",function(a){a.stopPropagation()}).on("change",function(a){b.focus()});if(navigator.userAgent.match(/(ipad|ipod|iphone)/i)){var e=!1;b.on("touchstart",function(a){e=!0;setTimeout(function(){e=!1},300)});$(document).off("touchstart.jip").on("touchstart.jip",function(a){e||c.find("form").trigger("submit")})}this.blurEvent(b,
b,"submit");var f=$.trim(c.text());b.attr("checked",f==a[1]);return b},value:function(){return this.inputField.prop("checked")?1:0},displayValue:function(c){return this.choices["0"!=c?1:0]},finish:function(){$(document).off("touchstart.jip")}};
$.fn.jinplace.editors["extra:checkbox_demo"]={blurAction:"ignore",makeField:function(c,d){var a=$("<label/>"),b=$('<input type="checkbox">');a.append(b);var e=$.trim(c.text()),f;f="["==d.charAt(0)?$.parseJSON(d):["No","Yes"];b.attr("checked",f[1]==e);e=$("<span>"+e+"</span>");a.append(e);this.choices=f;this.inputField=b;this.label=a;this.textNode=e;return a},activate:function(c,d){var a=this;d.focus();var b=this.label;b.on("click",function(a){a.stopPropagation()}).on("change",function(c){c=a.inputField.prop("checked");
a.textNode.text(a.choices[c?1:0]);d.focus()});if(navigator.userAgent.match(/(ipad|ipod|iphone)/i)){var e=!1;b.on("touchstart",function(a){e=!0;setTimeout(function(){e=!1},300)});$(document).off("touchstart.jip").on("touchstart.jip",function(a){e||c.trigger("submit")})}this.blurEvent(this.inputField,b,"submit")},value:function(){return this.inputField.prop("checked")?1:0},displayValue:function(c){return this.choices[c?1:0]},finish:function(){$(document).off("touchstart.jip")}};
